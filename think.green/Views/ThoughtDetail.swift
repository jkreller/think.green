...
struct ThoughtDetail: View {
    // Data
    var thoughtDetailViewModel = ThoughtDetailViewModel()
    var thought: Thought
        ...
        return NavigationView {
            BaseView {
                GeometryReader { geometry in
                    VStack {
                        ThoughtTitle(image: Image(uiImage: self.thought.uiImage ?? UIImage()), title: self.thought.title, titleHeight: self.$titleHeight)
